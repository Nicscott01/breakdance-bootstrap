...
\Breakdance\ElementStudio\registerElementForEditing(
    "BricBreakdanceElements\\StatsGrid",
...
<path d="M16 0c-8.837 0-16 7.163-16 16s7.163 16 16 16 16-7.163 16-16-7.163-16-16-16zM20.586 23.414l-6.586-6.586v-8.828h4v7.172l5.414 5.414-2.829 2.829z"/>
    ...
    static function designControls()
    {
      ...
      "borders",
       ['type' => 'popout']
        ...
        "Notice",
        [],
        ['type' => 'alert_box', 'layout' => 'vertical', 'alertBoxOptions' => ['style' => 'warning', 'content' => '<p>This option should be used with caution. Text could overflow at different breakpoints. Make sure your width is set.</p>'], 'condition' => ['0' => ['0' => ['path' => 'design.items.perfect_circle', 'operand' => 'is set', 'value' => '']]]],
        false,
        false,
        [],
      )],
    ...
    {
        return ['0' => ['accepts' => 'string', 'path' => 'content.content.items[].number'], '1' => ['accepts' => 'string', 'path' => 'content.content.items[].text'], '2' => ['path' => 'settings.advanced.attributes[].value', 'accepts' => 'string'], '3' => ['path' => 'settings.advanced.attributes[].value', 'accepts' => 'string']];
    }
    ...
    {
        return ['design.items.perfect_circle'];
    }
